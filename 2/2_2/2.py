...
# Примечание 1. Гарантируется, что введенные три буквы находятся в
# наборе "AaBCcEeHKMOoPpTXxy" + "АаВСсЕеНКМОоРрТХху" (английские + русские буквы).


def check_letters(first: str, second: str, third: str) -> str:
    eng = "AaBCcEeHKMOoPpTXxy"
    return ["ru", "mix", "mix", "en"][sum((first in eng, second in eng, third in eng))]

print(check_letters(input(), input(), input()))
